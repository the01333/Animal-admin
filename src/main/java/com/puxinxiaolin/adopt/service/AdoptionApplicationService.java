...
public interface AdoptionApplicationService extends IService<AdoptionApplication> {
     ...
     * @return 申请分页数据
     */
    Page<AdoptionApplicationVO> queryUserApplications(Page<AdoptionApplication> page, Long userId, String status);
     ...
     * @return 申请分页数据
     */
    Page<AdoptionApplicationVO> queryAllApplications(Page<AdoptionApplication> page, String status, String keyword);
