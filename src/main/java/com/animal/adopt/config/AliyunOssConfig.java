...
/**
 * MinIO configuration (legacy name kept for compatibility)
 */
@Data
@Configuration
...
public class AliyunOssConfig {
    ...
    /**
     * Deprecated legacy aliases for compatibility with旧配置
     */
    ...
    /**
     * Returns a public base URL for the configured bucket.
     */
